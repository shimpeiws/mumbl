...
describe('generateCallout', () => {
  ...
  it('should skip when no entries exist', async () => {
    ...
    const { createEntryRepository } = await import('../repositories/EntryRepository.js');
  ...
  it('should generate callout and write to message file', async () => {
    ...
    const { createProvider } = await import('../services/llm/LLMService.js');
